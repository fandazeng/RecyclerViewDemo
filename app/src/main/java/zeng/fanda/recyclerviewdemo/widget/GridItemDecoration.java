...
//            }
    ...
    public static class Builder {
        ...
        public Builder setSpanResource(@DimenRes int span) {
            setHorizontalSpanResource(span);
            setVerticalSpanResource(span);
            return this;
        }
         ...
         * 通过dp设置垂直间距
         * */
        public Builder setVerticalSpanResource(@DimenRes int vertical) {
        ...
        public Builder setVerticalSpan(int mVertical) {
            this.mVerticalSpan  = (int) DpUtil.dp2px(mContext,mVertical);
            return this;
        }
         ...
         * 通过dp设置水平间距
         * */
        public Builder setHorizontalSpanResource(@DimenRes int horizontal) {
        ...
        public Builder setHorizontalSpan(int horizontal) {
            this.mHorizonSpan  = (int) DpUtil.dp2px(mContext,horizontal);
            return this;
        }
